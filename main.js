...
function Setup() {
    ...
    english.style.visibility = 'visible';  // Ensure English is visible initially
    kanji.style.visibility = 'hidden';     // Ensure Kanji is hidden initially
...
function Next() {
    if (hidden) {
        ...
        right.style.display = 'none';
        english.textContent = 'under construction';
        english.style.fontSize = '40px';
        kanji.textContent = 'sisanya otw';
